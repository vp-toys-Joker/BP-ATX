...
.endif
    ...
    in button_state, pinB  ; установка состояния нажатия кнопки
    ldi temp1, 0x02
    and button_state, temp1
    lsr button_state
    clr button_event  ; сброс состояния обработчика контроля напряжения
...
main_state0_mode0:
    ...
    clr button_event ; сброс события от кнопки
    cp button_state, const_1  ; проверка состояния кнопки
    breq main_state0_mode0_set_mode1  ; если 1 - Включение БП
    ; если 0
    ;=====================================================
    ; Кнопка была нажата. Выдача звукового сигнала
    ;=====================================================
    ldi temp3, 1    ; запустить таймер сразу после инициализации
...
main_state0_mode1_off:
    ...
    ldi temp2, 0x08
    or temp1, temp2
    out portB, temp1  ; установить в 1 сигнал PS_ON БП
...
main_state1_mode0:
    ...
    clr button_event ; сброс события от кнопки
    cp button_state, const_1  ; проверка состояния кнопки
    breq main_state1_mode0_set_mode1  ; если 1 - Включение БП
    ; если 0
    ;=====================================================
    ; Кнопка была нажата. Выдача звукового сигнала
    ;=====================================================
